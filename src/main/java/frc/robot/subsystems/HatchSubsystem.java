...
public class HatchSubsystem extends SubsystemBase {
  ...
  private final DoubleSolenoid m_hatchSolenoid = new DoubleSolenoid(HatchConstants.SOLENOID_PORT,
      HatchConstants.kHatchSolenoidPorts[0], HatchConstants.kHatchSolenoidPorts[1]);

...
public class TrajectoryTracking {
    ...
    public TrajectoryTracking(DriveSubsystem driveSubsystem) {
        ...
        // TrajectoryConfig configReverse = new
        // TrajectoryConfig(DriveConstants.MAX_METERS_PER_SECOND,
        // DriveConstants.MAX_ACCELERATION_METERS_PER_SECOND_SQUARED)
        // // Add kinematics to ensure max speed is actually obeyed
        // .setKinematics(DriveConstants.DRIVE_KINEMATICS)
        // .addConstraint(Constants.MiscConstants.autoVoltageConstraint);
        ...
        testingTrack =
                ...
                TrajectoryGenerator.generateTrajectory(
                        ...
                        configForward);
        blueAllyTrenchParallelBack = TrajectoryGenerator
                .generateTrajectory(List.of(new Pose2d(12.897 / divisor, -0.69215 / divisor, new Rotation2d(0)),
                        new Pose2d(9.897 / divisor, -0.69215 / divisor, new Rotation2d(0))), configForward);
        // blueOpponentTrenchSteal =
        // blueOpponentTrenchBack =
        redAllyTrenchParallelBack = TrajectoryGenerator
                .generateTrajectory(List.of(new Pose2d(3.048 / divisor, -2.404364 / divisor, new Rotation2d(0)),
                        new Pose2d(6.048 / divisor, -2.404364 / divisor, new Rotation2d(0))), configForward);
        redOpponentTrenchSteal = TrajectoryGenerator
                .generateTrajectory(List.of(new Pose2d(3.048 / divisor, 7.831836 / divisor, new Rotation2d(0)),
                        new Pose2d(5.249926 / divisor, 7.831836 / divisor, new Rotation2d(0))), configForward);
        ...
        // try {
        // trajectory2 =
        // TrajectoryUtil.fromPathweaverJson(Paths.get("/home/lvuser/deploy/StraightPath.wpilib.json"));
        // } catch (IOException e) {
    ...
    public RamseteCommand getRamsete(Trajectory traj) {
        return new RamseteCommand(traj, driveSubsystem::getPose,
                ...
                new SimpleMotorFeedforward(PIDConstants.KS_FEEDFOWARD, PIDConstants.KV_FEEDFOWARD,
                        PIDConstants.KA_FEEDFOWARD),
                DriveConstants.DRIVE_KINEMATICS, driveSubsystem::getWheelSpeeds,
                new PIDController(PIDConstants.OPTIMAL_KP, 0, 0), new PIDController(PIDConstants.OPTIMAL_KP, 0, 0),
                driveSubsystem::setOutputVoltage, driveSubsystem);
    }
    // @Test
